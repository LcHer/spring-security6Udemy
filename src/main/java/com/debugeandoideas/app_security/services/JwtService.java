package com.debugeandoideas.app_security.services;
...
public class JwtService {
    ...
    public static  final String  JWT_SECRET = "EstaEsUnaClaveSuficientementeLargaYSeguraParaCumplirConLos256Bits";
